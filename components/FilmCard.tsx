...
export default function FilmCard({
  ...
  return (
    <div className="group relative overflow-hidden rounded-xl bg-white dark:bg-zinc-900 shadow-md hover:shadow-2xl transition-all duration-300 flex flex-col h-full">
      {/* Poster Image */}
